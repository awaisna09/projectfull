...
import { MockExamSubjectSelection } from './components/MockExamSubjectSelection';
...
function AppContent() {
  ...
  const renderPage = () => {
    switch (currentPage) {
      ...
      case 'mock-exam-subject-selection':
        return <MockExamSubjectSelection />;
      case 'mock-exam-p2':
        return <MockExamP2 />;
